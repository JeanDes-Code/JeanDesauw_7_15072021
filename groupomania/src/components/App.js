        ...
        <div className="header">
          ...
          <div className="nav-bar">
            <Link className="nav-item" to="/">
              {" "}
              <span className="item-hide">Accueil</span>{" "}
              <span className="nav-item-logo">{home}</span>{" "}
            </Link>
            <Link className="nav-item" to="/post">
              {" "}
              <span className="item-hide">Publier</span>{" "}
              <span className="nav-item-logo">{publish}</span>{" "}
            </Link>
            <Link className="nav-item" to="/myAccount">
              {" "}
              <span className="item-hide">Compte</span>{" "}
              <span className="nav-item-logo">{user}</span>{" "}
            </Link>
            <button className="nav-item" onClick={logout}>
              {" "}
              <span className="item-hide">Déconnexion</span>{" "}
              <span className="nav-item-logo">{signout}</span>{" "}
            </button>
          </div>
        </div>
        <Switch>
