...
router.post("/post/article", auth, multer, middleware(schemas.articleSchema), articles.create);

router.get("/get/article", auth, articles.findAll);

router.get("/get/article/:id", auth, articles.findOne);

router.put("/update/article/:id", auth, multer, middleware(schemas.articleSchema), articles.update);
